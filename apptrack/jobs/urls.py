...
urlpatterns = [
    ...
    path('interview-detail/<int:interview_id>/',
         views.interview_detail_view, name='interview_detail'),
    path("interview-edit/<int:interview_id>/",
         views.interview_edit_view, name="edit_interview"),
    ...
    path('job-assign/<str:col_id>/<str:job_id>/',
         views.JobAssignView.as_view(), name='assign_job'),
