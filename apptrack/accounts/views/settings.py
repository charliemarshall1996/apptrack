...
def settings_view(request, id):
    ...
    if profile.user != request.user:
        messages.error(request, "You are not authorized to view or edit this profile.")
    ...
    if request.method == "POST":
        ...
        if user_form.is_valid() and profile_form.is_valid():
            ...
            messages.success(request, AccountsMessageManager.profile_update_success)
            ...
            if not profile_form.is_valid():
                ...
                if errors.get("birth_date"):
                    messages.error(request, AccountsMessageManager.invalid_birth_date)
