...
from accounts.views.utils import ConversionCalculator
...
def test_conversion_calculator_basic_conversion_rate():
    ...
    assert ConversionCalculator.calculate_basic_conversion_rate(
        applications, interviews_or_offers) == answer
...
def test_conversion_calculator_conversion_rate():
    ...
    assert ConversionCalculator.calculate_conversion_rate(
        applications, interviews, offers) == answer
...
def test_conversion_calculator_conversion_score():
    ...
    assert ConversionCalculator.calculate_conversion_score(
        applications, interviews, offers) == answer
